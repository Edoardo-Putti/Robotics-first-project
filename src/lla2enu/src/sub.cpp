...
public:
 pub_sub_car(){
   ...
   frame = n.getNamespace();  
   //n = ros::NodeHandle n(frame);
   frame.erase(0,1);
   ...
   pub_odom = n.advertise<nav_msgs::Odometry>("/odom_"+frame, 1);
 ...
 void callback(const sensor_msgs::NavSatFix::ConstPtr& msg){
  ...
  odom.header.frame_id = "map";
      ...
      odom.child_frame_id = "car_"+ frame;
  ...
  br.sendTransform(tf::StampedTransform(transform, ros::Time::now(), "map", "tf_"+frame));
